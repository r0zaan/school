                    ...
                    <div class="row">
                        @foreach($products as $product)
                            <div class="col-sm-6 col-md-6 col-lg-4 ftco-animate">
                                <div class="product">
                                    <a href="{{url('product/'.$product->slug)}}" class="img-prod"><img class="img-fluid"
                                                                      src="{{url($product->colorImages()->first()->image)}}"
                                                                      alt="Colorlib Template">
                                       @if(isset($product->discount_percentage)) <span class="status">{{$product->discount_percentage}}%</span>@endif
                                    ...
                                    <div class="text py-3 px-3">
                                        ...
                                        <div class="d-flex">
                                            <div class="pricing">
                                                    ...
                                                    <span
                                                            class="price-sale">{{$product->discount_price}}</span></p>
                                                @else
