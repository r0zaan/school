                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <button type="button" class="btn btn-primary ajax-modal"
                                        data-url="{{ action('Backend\GroupController@create') }}"
                                ...
                                <table id="group" class="table table-bordered table-hover">
                                    ...
                                    @foreach($groups as $key => $group)
                                        <tr>
                                            ...
                                            <td>
                                                <a title="Show"
                                                   data-url="{{action('Backend\GroupController@show', $group->id)}}"
                                                   class="btn btn-primary ajax-modal"><i class="fa fa-eye"></i></a>
                                               <a title="Edit"
                                                       data-url="{{action('Backend\GroupController@edit', $group->id)}}"
                                                       class="btn btn-success ajax-modal"><i
                                                                class="fa fa-pencil-square-o"></i></a>
                                              <form action="{{ route('groups.destroy', array($group->id)) }}"
