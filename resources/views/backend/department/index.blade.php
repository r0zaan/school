                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <button type="button" class="btn btn-primary ajax-modal"
                                        data-url="{{ action('Backend\DepartmentController@create') }}"
                                ...
                                <table id="brand" class="table table-bordered table-hover">
                                    ...
                                    @foreach($departments as $key => $department)
                                        <tr>
                                            ...
                                            <td>
                                            <a title="Show"
                                                   data-url="{{action('Backend\DepartmentController@show', $department->id)}}"
                                                   class="btn btn-primary ajax-modal"><i class="fa fa-eye"></i></a>
                                               <a title="Edit"
                                                       data-url="{{action('Backend\DepartmentController@edit', $department->id)}}"
                                                       class="btn btn-success ajax-modal"><i
                                                                class="fa fa-pencil-square-o"></i></a>
                                              <form action="{{ route('departments.destroy', array($department->id)) }}"
