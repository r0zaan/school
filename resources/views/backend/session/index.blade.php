                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <button type="button" class="btn btn-primary ajax-modal"
                                        data-url="{{ action('Backend\SessionController@create') }}"
                                ...
                                <table id="brand" class="table table-bordered table-hover">
                                    ...
                                    @foreach($sessions as $key => $session)
                                        <tr>
                                            ...
                                            <td>
                                            <a title="Show"
                                                   data-url="{{action('Backend\SessionController@show', $session->id)}}"
                                                   class="btn btn-primary ajax-modal"><i class="fa fa-eye"></i></a>
                                               <a title="Edit"
                                                       data-url="{{action('Backend\SessionController@edit', $session->id)}}"
                                                       class="btn btn-success ajax-modal"><i
                                                                class="fa fa-pencil-square-o"></i></a>
                                              <form action="{{ route('sessions.destroy', array($session->id)) }}"
