                    ...
                    <div class="col-xs-12">
                        <div class="box box-primary">
                            ...
                            <button type="button" class="btn btn-primary ajax-modal"
                                    data-url="{{ action('Backend\DesignationController@create') }}"
                                ...
                                <table id="brand" class="table table-bordered table-hover">
                                    ...
                                    @foreach($designations as $key => $designation)
                                        <tr>
                                            ...
                                            <td>
                                                <a title="Show"
                                                   data-url="{{action('Backend\DesignationController@show', $designation->id)}}"
                                                   class="btn btn-primary ajax-modal"><i class="fa fa-eye"></i></a>
                                                <a title="Edit"
                                                   data-url="{{action('Backend\DesignationController@edit', $designation->id)}}"
                                                   class="btn btn-success ajax-modal"><i
                                                            class="fa fa-pencil-square-o"></i></a>
                                                <form action="{{ route('designations.destroy', array($designation->id)) }}"
